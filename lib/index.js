...
var Resizable = function (_React$Component) {
  ...
  function Resizable(props) {
    ...
    _this.setResizable = _this.setResizable.bind(_this);
  ...
  createClass(Resizable, [{
    ...
    value: function render() {
      ...
      return createElement(
        ...
        this.state.isResizing && createElement('span', {
          style: {
            height: '100%',
            width: '100%',
    ...
    get: function get$$1() {
      ...
      var getSize = function getSize(key) {
        if (typeof _this3.state[key] === 'undefined' || _this3.state[key] === 'auto') return 'auto';
        if (_this3.propsSize && _this3.propsSize[key] && endsWith(_this3.propsSize[key].toString(), '%')) {
          if (endsWith(_this3.state[key].toString(), '%')) return _this3.state[key].toString();
          var parentSize = _this3.getParentSize();
          var value = Number(_this3.state[key].toString().replace('px', ''));
          var percent = value / parentSize[key] * 100;
          return percent + '%';
        }
        return getStringSize(_this3.state[key]);
      };
